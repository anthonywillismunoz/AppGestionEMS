...
namespace AppGestionEMS.Controllers
{
    ...
    public class AsignacionDocentesController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.GrupoClaseId = new SelectList(db.GrupoClases, "Id", "descripcion");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,CursoId,GrupoClaseId")] AsignacionDocentes asignacionDocentes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CursoId,GrupoClaseId")] AsignacionDocentes asignacionDocentes)
        {
            if (ModelState.IsValid)
            {
