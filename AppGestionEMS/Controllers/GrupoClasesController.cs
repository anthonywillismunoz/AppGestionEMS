...
namespace AppGestionEMS.Controllers
{
    ...
    public class GrupoClasesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,descripcion")] GrupoClase grupoClase)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,descripcion")] GrupoClase grupoClase)
        {
            if (ModelState.IsValid)
            {
